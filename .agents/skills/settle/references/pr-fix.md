...
3. Check: does this test pass on the base branch? (`git stash && git checkout master && run test`)
...
3. Check: does this pass on the base branch? (`git stash && git checkout master && dagger call check`)
